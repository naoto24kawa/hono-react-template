...
reference: https://docs.github.com/ja/copilot/reference/custom-agents-configuration
---
...
- Use relative links (e.g., `__docs__/CONTRIBUTING.md`) instead of absolute URLs for files within the repository
